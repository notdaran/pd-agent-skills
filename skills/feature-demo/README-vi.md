...
![Analytics + AI translation, device duo side-by-side](./preview/analytics-translation-duo.png)

![Heatmaps hero, device duo overlap](./preview/heatmaps-device-duo.png)
...
Skill này nằm trong bộ [pd-agent-skills](../../README-vi.md). Từ thư mục gốc của repo:
...
Lệnh đó tạo symlink mọi skill vào `~/.claude/skills/` và cài lệnh
`/feature-demo`. Sau đó cài thêm phần renderer riêng của skill này:
...
### Chạy độc lập (chỉ renderer, không cần agent)
